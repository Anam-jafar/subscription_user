        ...
        <div class="container-fluid">
            ...
            <form method="POST" id="financial_form" action="" class="bg-white sm:p-2 text-xs">
                ...
                @if ($instituteType == 'SD')
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            <x-input-field level="Bagi Tahun" id="ye" name="fin_year" type="select" placeholder="Year"
                                :valueList="$years" value="{{ $financialStatement->fin_year }}" />

                            <x-input-field level="Kategori Penyata" id="statment" name="fin_category" type="select"
                                placeholder="Pilih" :valueList="$commonData['statements']" value="{{ $financialStatement->fin_category }}" />
                            <x-input-field level="Peratus Kemajuan Pembinaan Terkini (%)" id="p1"
                                name="latest_construction_progress" type="text" placeholder="00"
                                value="{{ $financialStatement->latest_construction_progress }}" />
                        </div>
                        ...
                        <div class="grid grid-cols-4 gap-6">
                            <x-input-field level="(i) Kos Pembinaan (Asal, RM)" id="i1" name="ori_construction_cost"
                                ...
                                value="{{ $financialStatement->ori_construction_cost }}" />
                        ...
                        <div class="grid grid-cols-3 gap-6 mt-4 mb-4">
                            <div class="flex flex-col">
                                <label for="input3" class="text-gray-800 font-medium mb-2">Penyata Kewangan Dan Nota
                                    Kewangan <span class="text-red-500 ">*</span></label>
                                <input type="file"
                    ...
                    <div>
                        ...
                        <div class="grid grid-col-2 md:grid-cols-4 gap-6">
                            <x-input-field level="Jumlah Pendapatan (Auto Calculate, RM)" id="total_income"
                                ...
                                :required="true" :readonly="true" value="{{ $financialStatement->total_income }}" />
                            ...
                            <x-input-field level="Jumlah Lebihan (Auto Calculate, RM)" id="total_surplus"
                                ...
                                :required="true" :readonly="true" value="{{ $financialStatement->total_surplus }}" />
                        </div>
                        <div class="grid grid-col-2 md:grid-cols-3 gap-6">
                ...
                <div class="grid grid-cols-1 gap-x-16 gap-y-2 max-w-3xl mt-8">
                    ...
                    <x-show-key-value :key="'Jawatan'" :value="Auth::user()->userPosition->parameter" />
