        ...
        <div class="container-fluid">
            ...
            <form method="POST" action="" class="bg-white sm:p-2 text-xs">
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <x-input-field level="Input 2" id="input2" name="input2" type="text" placeholder="Enter Input 2" />
                ...
                <!-- Checkbox with outline and text beside it -->
                <label class="flex items-center mt-4">
                    <input type="checkbox" id="myCheckbox" class="mr-2 border-3 border-gray-900 rounded p-1">
                    <span class="text-red-500">Check the check box</span>
                </label>
