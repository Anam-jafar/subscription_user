                    ...
                    <div class="mt-4 mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class=" max-w-3xl mt-4 space-y-2">
                                <x-show-key-value :key="'Tahun Permohonan'" :value="$financialStatement->cancellation_date" />
                                <x-show-key-value :key="'Status Pembatalan'" :value="$financialStatement->submission_status_" />
                                <x-show-key-value :key="'Alasan Pembatalan'" :value="$financialStatement->cancel_reason_byuser" />
                        ...
                        <div class="flex flex-col md:flex-row justify-between mt-8 space-y-4 md:space-y-0">
                            ...
                            <!-- Form for Sahkan button -->
                            <form action="{{ route('financialStatementCancellation', $financialStatement->id) }}"
                                method="POST">
                                @csrf
