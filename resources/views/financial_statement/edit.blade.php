          ...
          <div class="box">
            ...
            <div class="box-body !p-0">
              <form class="wizard wizard-tab horizontal" id="financial_form" method="POST"
                action="{{ route('editStatement', ['id' => $financialStatement->id]) }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="gap-y-4 sm:gap-x-6">
                              <div class="grid-cols1 grid gap-6 md:grid-cols-2">
                                <div class="grid grid-cols-2 gap-6">
                                  <x-input-field level="Bagi Tahun" id="ye" name="fin_year" type="select"
                                    placeholder="Year" :valueList="$years" value="{{ $financialStatement->fin_year }}"
                                    :required="true" />

                                  <x-input-field level="Kategori Penyata" id="statment" name="fin_category"
                                    type="select" placeholder="Pilih" :valueList="$parameters['statements']"
                                    value="{{ $financialStatement->fin_category }}" :required="true" />
                                </div>
                                <x-input-field level="Peratus Kemajuan Pembinaan Terkini (%)"
                                  ...
                                  placeholder="00" value="{{ $financialStatement->latest_contruction_progress }}"
                                  :required="true" />
                              ...
                              <div class="grid-cols1 grid gap-6 md:grid-cols-2">
                                <x-input-field level="(i) Kutipan Semasa (RM)" id="current_collection"
                                  ...
                                  :required="true" value="{{ $financialStatement->current_collection }}" />
                                <x-input-field level="(ii) Kutipan Terkumpul (RM)" id="total_expenses"
                                  name="total_expenses" type="money" placeholder="00.00" :rightAlign="true"
                                  :required="true" value="{{ $financialStatement->total_expenses }}" />
                              </div>
                              ...
                              <div class="grid-cols1 grid gap-6 md:grid-cols-2">
                                <x-input-field level="(i) Lebihan Masjid/Surau (RM)" id="inst_surplus"
                                  name="inst_surplus" type="money" placeholder="00.00" :rightAlign="true"
                                  :required="true" value="{{ $financialStatement->inst_surplus }}" />
                            ...
                            <div class="gap-y-4 sm:gap-x-6">
                              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <x-input-field level="(a) Baki Bawa Ke Hadapan 1 Januari (RM)" id="balance_forward"
                                  ...
                                  :required="true" value="{{ $financialStatement->balance_forward }}" />
                              ...
                              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <x-input-field level="(b) Jumlah Kutipan (RM)" id="total_collection"
                                  ...
                                  :required="true" value="{{ $financialStatement->total_collection }}" />
                              ...
                              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <x-input-field level="(f) Maklumat Baki Bank Dan Tunai (RM)" id="bank_cash_balance"
                                  ...
                                  :required="true" value="{{ $financialStatement->bank_cash_balance }}"
                                  :readonly="true" />
                              </div>
                            </div>
                          @endif
                        ...
                        <div class="register-page">
                            ...
                            <div class="gap-y-4 sm:gap-x-6">
                              ...
                              <div class="grid-cols1 grid gap-6 md:grid-cols-2">
                                <div class="mt-4 flex flex-col">
                                  <label for="input3" class="mb-2 text-gray-800">Penyata
                                    Kewangan
                                    <span class="text-red-500">*</span></label>

                                  <input type="file" id="attachment1" name="attachment1" accept=".pdf"
                                  ...
                                  @if (!empty($financialStatement->attachment1))
                                    <span class="mb-1 text-xs italic text-gray-600">
                                      Current file:
                                ...
                                <div class="mt-4 flex flex-col">
                                  ...
                                  <input type="file" id="attachment2" name="attachment2" accept=".pdf"
                                    onchange="validateFiles()"
                                    class="block h-[3rem] w-full rounded-sm border border-gray-200 text-sm text-textmuted file:me-4 file:h-[3rem] file:rounded-s-sm file:border-0 file:bg-primary file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-primary focus:z-10 focus:border-gray-200 focus:shadow-sm focus:outline-0 focus-visible:outline-none dark:border-white/10 dark:text-textmuted/50 dark:focus:border-white/10 dark:focus:shadow-white/10">
                              ...
                              <div class="grid-cols1 grid gap-6 md:grid-cols-2">
                                <div class="mt-4 flex flex-col">
                                  <label for="input3" class="mb-2 text-gray-800">Certificate
                                    Completion &
                                    Compliance (CCC)</label>
                          ...
                          @else
                            <div class="gap-y-4 sm:gap-x-6">
                              ...
                              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div class="mt-4 flex flex-col">
                                  <label for="input3" class="mb-2 text-gray-800">Penyata Kewangan Dan
                                    Nota Kewangan
                                    <span class="text-red-500">*</span></label>
