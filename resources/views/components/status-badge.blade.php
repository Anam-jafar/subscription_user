...
@php
    $statusStyles = [
        ...
        'status' => [
            1 => ['text' => 'Submitted', 'class' => 'bg-green-100 text-green-700 border-green-500 rounded-sm'],
            0 => ['text' => 'Draft', 'class' => 'bg-yellow-100 text-yellow-700 border-yellow-500 rounded-sm'],
