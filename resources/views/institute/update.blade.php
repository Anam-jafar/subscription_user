      ...
      <div class="grid grid-cols-12 gap-x-6">
        <div class="col-span-12 xl:col-span-12">
          <div class="box">
            ...
            <!-- Title -->
            <h1 class="mt-2 text-center font-mont text-3xl !font-normal text-[#2624D0]">KEMASKINI PROFIL MASJID
            </h1>
            <div class="md:px-6">
              <x-alert />
            </div>
                      ...
                      <div class="col-span-12 xl:col-span-12">
                        <div class="register-page">
                          <div class="gap-y-4">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                              <x-input-field level="Emel" id="poskod" spanText="Rasmi" name="mel" type="text"
                      ...
                      <div class="col-span-12 xl:col-span-12">
                        <div class="register-page">
                          ...
                          <div class="gap-y-4">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                              <x-input-field level="Dun" id="institusi" name="rem11" type="text" placeholder=""
