...
@section('content')
    <div class="space-y-16 p-6 max-w-screen-lg mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 max-w-3xl mx-auto p-4 bg-white">
            <!-- Name -->
            ...
            <div class="flex items-center">
                ...
                <span class="text-gray-600">{{ Auth::user()->userPosition->parameter }}</span>
            </div>

            <!-- Mobile Number -->
            <div class="flex items-center">
                <span class="text-gray-900 font-semibold w-24">No H/P:</span>
                <span class="text-gray-600">{{ Auth::user()->mobile_number }}</span>
            </div>
        ...
        <!-- Form -->
        <form class="max-w-3xl mx-auto space-y-6" action="{{ route('resetPassword') }}" method="POST">
            @csrf
            <x-alert />
